        ...
        <Route path="/">
          <Route element={<PrivateRoute />}>
            <Route element={<PrivLayout isOpened={isOpened} setIsOpened={setIsOpened} />}>
              ...
              <Route
                path="/publicacion/:id"
                element={<DetallesPublicacion isOpened={isOpened} setIsOpened={setIsOpened} />}
              />
              <Route
                path="/listado-publicaciones"
                element={<PublicacionesListado isOpened={isOpened} setIsOpened={setIsOpened} />}
              />
              ...
              <Route
                path="/anuncio-formulario"
                element={<AnuncioFormulario isOpened={isOpened} setIsOpened={setIsOpened} />}
              />
              ...
              <Route
                ...
                element={<CuentaUsuario isOpened={isOpened} setIsOpened={setIsOpened} />}
              />
              <Route path="/kanban" element={<Kanban isOpened={isOpened} setIsOpened={setIsOpened} />} />
              <Route
                path="/detalle-modificacion-publicacion/:id"
                element={<DetalleModificacionPublicacion isOpened={isOpened} setIsOpened={setIsOpened} />}
              />
            </Route>
          </Route>
